    ...
    return (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-5">
          <div className="space-y-10 p-4">
            ...
            A80 MODERN Smart Desktop
            </h2>
            <p className="text-gray-600 text-xl">
            A desktop device in the Android series, it combines the potential of SmartPOS with the ease of use of traditional desktop terminals.
            </p>
            <Link to="/contact">
          ...
          <div className="w-full h-full">
            <img
              ...
              src="/images/Website_pictures_for_A-series-3_dwwytk.webp"
              alt="img"
            />
          </div>
        </div>
