  ...
  return (
    <div>
      <div className="max-w-7xl mx-auto px-2 lg:px-0 pt-32 lg:pt-48 pb-20">
        <h1 className="text-2xl lg:text-5xl text2 font-medium mb-10">Vendrax Focuses</h1>
        <div className="grid grid-cols-1 md:grid-cols-2 justify-items-center items-end gap-2 md:gap-8 lg:gap-1">
          ...
          <div>
            <h4 className="text2 text-xl lg:text-2xl mt-6 md:mt-0 ">On Reporting, Financials, and Measurable Goals</h4>
