...
const ReferralBanner = () => {
  return (
    ...
    >
      <div
        className="w-[400px] md:w-[800px] lg:w-[1400px] mx-auto px-4 lg:px-10 pt-14 lg:pt-10 absolute right-2/4 transform translate-x-1/2"
        style={{
      ...
      >
        ...
        <div className="mt-16 lg:mt-40">
          <div className="shadow-xl max-w-screen-xl mx-auto p-8 md:p-20 bg-white rounded-3xl relative">
            ...
            <img
              className="absolute hidden lg:flex top-10 lg:-right-16"
            ...
            />
            <img
              className="absolute -z-10 hidden lg:flex -bottom-10 lg:-right-36"
